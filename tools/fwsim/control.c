...
void apply_accel(float linear_accel[2], float angular_accel) {
	...
	float scaling = 10.0;// Assume no motor limitations. Main limiter will be wheel slip get_maximal_accel_scaling(linear_accel, angular_accel);
