...
Drive::Robot::Robot(
    ...
    : index(index),
      ...
      dribbler_speed(0),
      board_temperature(0),
      lps_values{Property<double>(0.0), Property<double>(0.0),
                 Property<double>(0.0), Property<double>(0.0)},
      link_quality(0),
      ...
      low_battery_message(
          Glib::ustring::compose(u8"Bot %1 low battery", index),
          Annunciator::Message::TriggerMode::LEVEL,
          Annunciator::Message::Severity::HIGH),
      high_board_temperature_message(
          Glib::ustring::compose(u8"Bot %1 board hot", index),
          Annunciator::Message::TriggerMode::LEVEL,
          Annunciator::Message::Severity::HIGH)
{
    alive.signal_changed().connect(
        sigc::mem_fun(this, &Robot::handle_alive_changed));
    battery_voltage.signal_changed().connect(
        sigc::mem_fun(this, &Robot::handle_battery_voltage_changed));
    board_temperature.signal_changed().connect(
        sigc::mem_fun(this, &Robot::handle_board_temperature_changed));
}
