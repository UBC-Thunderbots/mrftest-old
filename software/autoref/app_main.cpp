...
int app_main(int argc, char **argv) {
	...
	//const std::unique_ptr<AI::BE::Backend> &beptr =  AI::BE::RO::get_factory().create_backend(disable_cameras, multicast_interface_index);
	...
	AI::AutoRef::getInstance(ai, AI::HL::W::World(backend));
