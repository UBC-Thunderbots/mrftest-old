...
class StochasticLocalSearch {
	...
	public:
		...
		/**
		 * If the cost is better than the current best cost then set the current parameters to be the best parameters and
		 * the cost to be the best cost.  Otherwise the current parameters are set to the best parameters.
		 *
		...
		/**
		 * Pick a parameter at random and then set it's value to a random value within it's min and max values.
		 */
		void hill_climb();
