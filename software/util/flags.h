...
{ \
	return static_cast<CLASS>(static_cast<UNDERLYING>(lhs) | static_cast<UNDERLYING>(rhs)); \
} \
static inline CLASS& operator|=(CLASS& lhs, CLASS rhs) \
{ \
	lhs = static_cast<CLASS>(static_cast<UNDERLYING>(lhs) | static_cast<UNDERLYING>(rhs)); \
	return lhs; \
} \
static constexpr inline CLASS operator&(CLASS lhs, CLASS rhs) \
{ \
