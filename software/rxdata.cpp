...
namespace {
	class StateMachine : public NonCopyable, public sigc::trackable {
		public:
			StateMachine(Glib::RefPtr<Glib::MainLoop> loop, const RefPtr<XBeeRawBot> bot) : loop(loop), bot(bot) {
...
#warning unportable, replace with proper encoding/decoding
	...
	int main_impl(int argc, char **argv) {
		...
		const RefPtr<XBeeRawBot> bot(XBeeRawBot::create(botinfo.address, modem));
