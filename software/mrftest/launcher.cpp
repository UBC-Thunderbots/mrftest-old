#include "mrftest/launcher.h"
#include <algorithm>
#include <cstddef>

using namespace std::placeholders;

TesterLauncher::TesterLauncher(MRFDongle &dongle) : dongle(dongle), table(3, 4, true), mapper_toggle(u8"Joystick Mapper") {
	set_title(u8"Tester");
	...
	table.attach(mapper_toggle, 0, 4, 2, 3, Gtk::FILL | Gtk::EXPAND, Gtk::FILL | Gtk::SHRINK);
