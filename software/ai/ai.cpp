...
AIPackage::AIPackage(Backend &backend) : backend(backend), high_level(std::unique_ptr<AI::HL::HighLevel>()), navigator(AI::Nav::Navigator::Ptr()), show_hl_overlay(true), show_nav_overlay(true) {
