 ...
 *
 * Inverting a play type causes any play type which refers to “friendly” to
 * refer to “enemy” and vice versa.
...
inline constexpr bool operator<(PlayType a, PlayType b)
{
...
{
template <>
struct hash<AI::Common::PlayType>
{
