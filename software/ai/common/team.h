 ...
 *
 * \return \c true if the iterators point to the same element of the same team,
 * or \c false if not
 */
template <typename T, typename U>
bool operator==(const TeamIterator<T, U> &x, const TeamIterator<T, U> &y);
 ...
 * \param[in] y the second iterator
 *
 * \return \c false if the iterators point to the same element of the same team,
 * or \c true if not
 */
template <typename T, typename U>
bool operator!=(const TeamIterator<T, U> &x, const TeamIterator<T, U> &y);
 ...
 */
template <typename T, typename U>
TeamIterator<T, U> operator+(
    TeamIterator<T, U> i, typename TeamIterator<T, U>::difference_type n);
...
template <typename T, typename U>
TeamIterator<T, U> operator+(
    typename TeamIterator<T, U>::difference_type n, TeamIterator<T, U> i);
 ...
 */
template <typename T, typename U>
typename TeamIterator<T, U>::difference_type operator-(
    const TeamIterator<T, U> &x, const TeamIterator<T, U> &y);
 ...
 */
template <typename T, typename U>
void swap(TeamIterator<T, U> &x, TeamIterator<T, U> &y);

template <typename T, typename U>
class TeamIterator final
    : public std::iterator<
          std::random_access_iterator_tag, T, ptrdiff_t, T *, T>
{
   ...
   private:
    ...
    friend typename TeamIterator<T, U>::difference_type operator-
        <T, U>(const TeamIterator &, const TeamIterator &);
...
class Team
{
   public:
    ...
    /**
     * \brief Returns the signal that is fired after a team’s membership has
     * changed.
     *
...
template <typename T, typename U>
inline bool AI::Common::operator==(
    const TeamIterator<T, U> &x, const TeamIterator<T, U> &y)
{
...
template <typename T, typename U>
inline AI::Common::TeamIterator<T, U> AI::Common::operator+(
    TeamIterator<T, U> i, typename TeamIterator<T, U>::difference_type n)
{
    i += n;
    return i;
...
template <typename T, typename U>
inline typename AI::Common::TeamIterator<T, U>::difference_type AI::Common::
operator-(const TeamIterator<T, U> &x, const TeamIterator<T, U> &y)
{
    return static_cast<
        typename AI::Common::TeamIterator<T, U>::difference_type>(
        x.pos - y.pos);
}

template <typename T, typename U>
inline void AI::Common::swap(TeamIterator<T, U> &x, TeamIterator<T, U> &y)
{
    using std::swap;
    swap(x.team, y.team);
    swap(x.pos, y.pos);
...
template <typename T, typename U>
inline AI::Common::TeamIterator<T, U>::TeamIterator(
    const Team<T, U> *team, std::size_t pos)
    : team(team), pos(pos)
{
    update_obj();
}
...
template <typename T, typename U>
inline T AI::Common::TeamIterator<T, U>::operator*() const
{
    return obj;
}
...
template <typename T, typename U>
inline T AI::Common::TeamIterator<T, U>::operator[](
    typename TeamIterator<T, U>::difference_type n) const
{
    return T((*team)[pos + n]);
}

template <typename T, typename U>
inline AI::Common::TeamIterator<T, U>
    &AI::Common::TeamIterator<T, U>::operator++()
{
    return *this += 1;
}

template <typename T, typename U>
inline AI::Common::TeamIterator<T, U> AI::Common::TeamIterator<T, U>::
operator++(int)
{
...
template <typename T, typename U>
inline AI::Common::TeamIterator<T, U> &AI::Common::TeamIterator<T, U>::
operator+=(typename TeamIterator<T, U>::difference_type n)
{
    pos = static_cast<std::size_t>(
        static_cast<typename AI::Common::TeamIterator<T, U>::difference_type>(
            pos) +
        n);
    update_obj();
    return *this;
...
template <typename T, typename U>
inline void AI::Common::TeamIterator<T, U>::update_obj()
{
    if (pos < team->size())
    {
        obj = (*team)[pos];
...
template <typename T, typename U>
inline AI::Common::Team<T, U>::Team(const AI::BE::Team<U> &impl) : impl(impl)
{
}

template <typename T, typename U>
inline AI::Common::Team<T, U>::Team(const Team<T, U> &) = default;

template <typename T, typename U>
inline unsigned int AI::Common::Team<T, U>::goalie() const
{
    return impl.goalie;
}

template <typename T, typename U>
inline unsigned int AI::Common::Team<T, U>::score() const
{
    return impl.score;
}

template <typename T, typename U>
inline typename AI::Common::Team<T, U>::iterator AI::Common::Team<T, U>::begin()
    const
{
...
template <typename T, typename U>
inline typename AI::Common::Team<T, U>::iterator AI::Common::Team<T, U>::end()
    const
{
...
template <typename T, typename U>
inline std::size_t AI::Common::Team<T, U>::size() const
{
    return impl.size();
}

template <typename T, typename U>
inline T AI::Common::Team<T, U>::operator[](std::size_t i) const
{
    return T(impl.get(i));
}

template <typename T, typename U>
inline sigc::signal<void> &AI::Common::Team<T, U>::signal_membership_changed()
    const
{
