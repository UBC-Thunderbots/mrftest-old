...
template<typename T, typename U> inline AI::Common::TeamIterator<T, U>::TeamIterator(const Team<T, U> *team, typename TeamIterator<T, U>::difference_type pos) : team(team), pos(pos), obj((*team)[pos]) {
}
