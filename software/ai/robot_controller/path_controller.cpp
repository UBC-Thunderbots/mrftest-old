...
namespace {
	...
	class PathController final : public RobotController, public TunableController {
		public:
			explicit PathController(World world, Player player) : RobotController(world, player), param(param_default) {
			}
