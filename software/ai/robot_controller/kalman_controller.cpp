	...
	class KalmanController : public RobotController {
		public:
			KalmanController(World &world, Player::Ptr player) : RobotController(world, player), 
						...
						adj_terminal_velocity(0.0, 0.0, 10.0, 0.1, 0.2, 0.2), hsb_terminal_velocity(adj_terminal_velocity), lbl_terminal_velocity("V terminal"), to_be_terminal_velocity(0.0),
						...
						adj_pivot_radius(0.1, 0.1, 10.0, 0.1, 1.0, 0.0), hsb_pivot_radius(adj_pivot_radius), lbl_pivot_radius("Pivot Radius"), to_be_pivot_radius(0.1),
						to_be_velocity(0.0,0.0), enable_pivot_radius(true) {
