...
MRFBackend::MRFBackend(MRFDongle &dongle, unsigned int camera_mask, int multicast_interface) : Backend(), refbox(multicast_interface), camera_mask(camera_mask), friendly(*this, dongle), enemy(*this), vision_rx(multicast_interface) {
	...
	vision_rx.signal_vision_data.connect(sigc::mem_fun(this, &MRFBackend::handle_vision_packet));
...
void MRFBackend::handle_vision_packet(const SSL_WrapperPacket &packet) {
