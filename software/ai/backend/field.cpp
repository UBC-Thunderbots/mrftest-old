...
void Field::update(double length, double total_length, double width, double total_width, double goal_width, double centre_circle_radius, double defense_area_radius, double defense_area_stretch) {
	Field old(*this);
