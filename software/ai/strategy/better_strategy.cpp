...
better_strategy::better_strategy(world::ptr world) : the_world(world) {
	update_wait = 0;
	update_wait_turns = 5;
	the_world->friendly.signal_robot_added.connect(sigc::hide(sigc::hide(sigc::mem_fun(this, &better_strategy::reset_all))));
	the_world->friendly.signal_robot_removed.connect(sigc::hide(sigc::hide(sigc::mem_fun(this, &better_strategy::reset_all))));
	the_world->signal_playtype_changed.connect(sigc::mem_fun(this, &better_strategy::reset_all));
}
