...
tactics[4] = Tactic::shadow_kickoff(
    world, Enemy::closest_ball(world, 1), ready_positions[0]);
tactics[5] = Tactic::shadow_kickoff(
    world, Enemy::closest_ball(world, 2), ready_positions[1]);
// tactics[5] = Tactic::move(world, Point(world.field().friendly_goal().x +
// world.field().defense_area_radius() + 3*Robot::MAX_RADIUS, 0));
