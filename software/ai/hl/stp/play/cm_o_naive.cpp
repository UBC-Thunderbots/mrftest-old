...
APPLICABLE(offensive(world))
DONE(!offensive(world))
FAIL(!offensive(world))
BEGIN_ASSIGN()
// GOALIE
...
// ROLE 3 (optional)
// cm defend point 2
roles[3].push_back(tdefend_point(world, Coordinate(world, Point(-1.4, -0.25), Coordinate::YType::BALL, Coordinate::OriginType::BALL), 0, 1.4));
