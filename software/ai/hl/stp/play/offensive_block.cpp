...
INVARIANT(Predicates::playtype(world, AI::Common::PlayType::PLAY)
		...
		&& !Predicates::enemy_baller_can_shoot(world)
		&& Predicates::enemy_baller_can_pass(world))
APPLICABLE(false && Predicates::their_ball(world) && Predicates::ball_midfield(world) && Predicates::ball_on_their_side(world))
