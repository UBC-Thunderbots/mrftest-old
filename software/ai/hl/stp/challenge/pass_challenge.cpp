...
namespace {
	...
	DegreeParam pass_separation_angle(u8"CHALLENGE: angle to separate players (degrees)", u8"AI/HL/STP/Challenge", 120.0, 30.0, 120.0);
	// how fast the baller should spin
	RadianParam baller_spin_delta(u8"CHALLENGE: change in orientation every time tick for move spin (radians)", u8"AI/HL/STP/Challenge", 1.0, 1.0, 5.0);
