...
namespace {
	...
	class SimPassPlayer : public HighLevel {
		public:
			SimPassPlayer(World &world) : world(world),
				orient(0.0), adj_orientation(0.0,0.0,2*M_PI,0.1*M_PI,0.5*M_PI), hsb_orientation(adj_orientation),
				xpos(0.0), adj_xposition(0.0,0.0,2*M_PI,0.1*M_PI,0.5*M_PI), hsb_xposition(adj_xposition), 
				ypos(0.0), adj_yposition(0.0,0.0,2*M_PI,0.1*M_PI,0.5*M_PI), hsb_yposition(adj_yposition) {
