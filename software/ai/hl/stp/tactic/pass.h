	...
	namespace HL {
		namespace STP {
			namespace Tactic {
				 ...
				 */
				std::pair<Tactic::Ptr, Tactic::Ptr> create_pass_pair(AI::HL::W::World& world, Point passer_pos, Point passee_pos);
				 ...
				 */
				Tactic::Ptr passer_ready(AI::HL::W::World& world, Point pos, Point target);
				 ...
				 */
				Tactic::Ptr passee_ready(AI::HL::W::World& world, Point pos);
				 ...
				 * \param [in] target where the passee should be.
				 */
				Tactic::Ptr passer_shoot(AI::HL::W::World& world, Point pos, Point target);
				 ...
				 * \param [in] pos where the passee should be.
				 */
				Tactic::Ptr passee_receive(AI::HL::W::World& world, Point pos);
			}
		}
	}
}
