	...
	namespace HL {
		namespace STP {
			namespace Tactic {
				...
				class StopLocations : public Cacheable<std::vector<Point>, CacheableNonKeyArgs<const AI::HL::W::World &>, CacheableKeyArgs<int> > {
					protected:
						std::vector<Point> compute(const World &w, int dummy);
				};
