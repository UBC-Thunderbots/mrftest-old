#include "ai/hl/stp/tactic/legacy_shadow_kickoff.h"
...
namespace {
	class ShadowKickoff final : public LegacyTactic {
		public:
			explicit ShadowKickoff(World world, Enemy::Ptr enemy, const Coordinate default_loc) : LegacyTactic(world), enemy(enemy), default_loc(default_loc) {
			}
	...
	class ShadowBall final : public LegacyTactic {
		public:
			explicit ShadowBall(World world) : LegacyTactic(world) {
			}
