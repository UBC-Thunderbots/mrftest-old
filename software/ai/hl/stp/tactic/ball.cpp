...
namespace {
	...
	class BackUpSteal final : public Tactic {
			public:
				explicit BackUpSteal(World world) : Tactic(world), state(BACKING_UP), finished(false), backup_dist(4 * Robot::MAX_RADIUS) {}
	...
	class TDribbleToRegion final : public Tactic {
		public:
			explicit TDribbleToRegion(World world, Region region_) : Tactic(world), region(region_) {}
	...
	class TSpinToRegion final : public Tactic {
		public:
			explicit TSpinToRegion(World world, Region region_) : Tactic(world), region(region_) {}
