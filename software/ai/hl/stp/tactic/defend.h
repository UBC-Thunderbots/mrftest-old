 ...
 */
Tactic::Ptr defend_duo_defender(World world, bool active_baller = false);
 ...
 */
Tactic::Ptr defend_duo_extra1(World world, bool active_baller = false);
 ...
 * A tactic for extra player.
 */
Tactic::Ptr defend_duo_extra2(World world, bool active_baller = false);
 ...
 * A tactic for extra player.
 */
Tactic::Ptr defend_duo_extra3(World world, bool active_baller = false);
 ...
 *
 * \input[in] defender_role the role index (starting from 0) that the
 * defender_duo_defender is.
 */
