...
namespace {
	...
	class TDefendLine : public Tactic {		
		public: 		
			TDefendLine(const World &world, const TCoordinate _p1, const TCoordinate _p2, const double _distmin, const double _distmax) : Tactic(world), p1(_p1), p2(_p2), distmin(_distmin), distmax(_distmax) {}			
	...
	class TDefendPoint : public Tactic {		
		public:
			TDefendPoint(const World &world, const TCoordinate _center, const double _distmin, const double _distmax) : Tactic(world), center(_center), distmin(_distmin), distmax(_distmax) {}
	...
	class TDefendLane : public Tactic {
		public:			
			TDefendLane(const World &world, const TCoordinate _p1, const TCoordinate _p2) : Tactic(world), p1(_p1), p2(_p2) {}
	...
	class TBlock : public Tactic {
		public:
			...
			TBlock(const World &world, const double _distmin, const double _distmax, const int _prefside) : Tactic(world), distmin(_distmin), distmax(_distmax), prefside(_prefside) {}
...
Tactic::Ptr AI::HL::STP::Tactic::tdefend_line(const World &world, const TCoordinate _p1, const TCoordinate _p2, const double _distmin, const double _distmax) {
	const Tactic::Ptr p(new TDefendLine(world, _p1, _p2, _distmin, _distmax));
	return p;
}

Tactic::Ptr AI::HL::STP::Tactic::tdefend_point(const World &world, const TCoordinate _center, const double _distmin, const double _distmax) {
	const Tactic::Ptr p(new TDefendPoint(world, _center, _distmin, _distmax));
	return p;
}

Tactic::Ptr AI::HL::STP::Tactic::tdefend_lane(const World &world, const TCoordinate _p1, const TCoordinate _p2) {
	const Tactic::Ptr p(new TDefendLane(world, _p1, _p2));
	return p;
}
/*
Tactic::Ptr AI::HL::STP::Tactic::tblock(const AI::HL::W::World &world) {
	const Tactic::Ptr p(new TBlock(world));
	return p;
}

Tactic::Ptr AI::HL::STP::Tactic::tmark(const AI::HL::W::World &world) {
	const Tactic::Ptr p(new TMark(world));
	return p;
}
*/
