...
#include "ai/hl/stp/action/legacy_block.h"
...
namespace {
	...
	class BlockGoal final : public LegacyTactic {
		public:
			explicit BlockGoal(World world, Enemy::Ptr enemy) : LegacyTactic(world), enemy(enemy) {
			}
...
//			player.dribble_stop();
	...
	class BlockBall final : public LegacyTactic {
		public:
			BlockBall(World world, Enemy::Ptr enemy) : LegacyTactic(world), enemy(enemy) {
			}
