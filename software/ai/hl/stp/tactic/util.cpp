...
Player AI::HL::STP::Tactic::select_baller(World world, const std::set<Player> &players, Player previous) {
	...
	if (world.playtype() == AI::Common::PlayType::EXECUTE_DIRECT_FREE_KICK_FRIENDLY || world.playtype() == AI::Common::PlayType::EXECUTE_INDIRECT_FREE_KICK_FRIENDLY || world.playtype() == AI::Common::PlayType::EXECUTE_KICKOFF_FRIENDLY || world.playtype() == AI::Common::PlayType::EXECUTE_PENALTY_FRIENDLY || world.playtype() == AI::Common::PlayType::PREPARE_KICKOFF_FRIENDLY || world.playtype() == AI::Common::PlayType::PREPARE_PENALTY_FRIENDLY) {
		if (previous) {
			return previous;
		}
	}
