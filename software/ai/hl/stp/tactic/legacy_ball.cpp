...
namespace {
	...
	class SpinSteal final : public LegacyTactic {
		public:
			explicit SpinSteal(World world) : LegacyTactic(world, true), none(false) {}
	...
	class BackUpSteal final : public LegacyTactic {
			public:
				explicit BackUpSteal(World world) : LegacyTactic(world, true), state(BACKING_UP), finished(false), backup_dist(4 * Robot::MAX_RADIUS) {}
	...
	class TActiveDef final : public LegacyTactic {
		public:
			explicit TActiveDef(World world) : LegacyTactic(world, true), finished(false) {}
	...
	class TDribbleToRegion final : public LegacyTactic {
		public:
			explicit TDribbleToRegion(World world, Region region_) : LegacyTactic(world, true), region(region_) {}
	...
	class TSpinToRegion final : public LegacyTactic {
		public:
			explicit TSpinToRegion(World world, Region region_) : LegacyTactic(world, true), region(region_) {}
