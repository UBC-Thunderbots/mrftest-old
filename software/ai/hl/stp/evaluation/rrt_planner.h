...
/**
 * This function decides how to move toward the target the target is one of a
 * random point,
 ...
 * optional parameter post_process sets whether to try and smooth out the final
 * path
 */
