 ...
 */
std::pair<Point, Angle> calc_enemy_best_shot_goal(
 ...
 */
std::pair<Point, Angle> calc_enemy_best_shot_goal(
    World world, const Robot enemy, const double radius = 1.0);
 ...
 */
std::vector<int> calc_min_enemy_pass(
    const std::vector<Point> obstacles, const std::vector<Point> enemies);
