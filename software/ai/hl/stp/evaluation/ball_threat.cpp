...
namespace {
	DoubleParam steal_threshold(u8"Steal threshold: distance of ball from enemy (robot radius)", u8"AI/HL/STP/evaluation", 1.1, 0.8, 5.0);

	DoubleParam negligible_velocity(u8"speed goalie should ignore direction of ball", u8"AI/HL/STP/evaluation", 0.05, 1e-4, 1.0);
}
