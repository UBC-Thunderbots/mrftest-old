...
void AI::HL::STP::Action::intercept_pivot(const AI::HL::STP::World &world, AI::HL::STP::Player::Ptr player, const Point target) {
...
void AI::HL::STP::Action::pivot(const AI::HL::STP::World &world, AI::HL::STP::Player::Ptr player, const Point target, const double radius) {
