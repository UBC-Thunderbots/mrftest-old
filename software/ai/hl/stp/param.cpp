...
Temp_AngleParam AI::HL::STP::Action::passer_angle_threshold("Angle threshold (in degrees) that defines passing accuracy, smaller is more accurate", "STP/Action/shoot", 5, 0.0, 90.0);

Temp_AngleParam AI::HL::STP::passee_angle_threshold("Angle threshold (in degrees) that the passee must be with respect to passer when shot, smaller is more accurate", "STP/Action/shoot", 80.0, 0.0, 90.0);
