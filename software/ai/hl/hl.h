...
class HighLevel : public NonCopyable
{
   public:
     ...
     * global instance of their corresponding HighLevelFactory.
     *
    ...
    /**
     * \brief Provides an opportunity for the high level to draw an overlay on
     * the visualizer.
     *
...
class HighLevelFactory : public Registerable<HighLevelFactory>
{
   public:
     ...
     */
    virtual std::unique_ptr<HighLevel> create_high_level(
        AI::HL::W::World world) const = 0;
   ...
   protected:
     ...
     */
    explicit HighLevelFactory(const char *name)
        : Registerable<HighLevelFactory>(name)
    {
    }
};
}
...
#define HIGH_LEVEL_REGISTER(cls)                                               \
    ...
    {                                                                          \
       public:                                                                 \
        ...
        std::unique_ptr<HighLevel> create_high_level(                          \
            AI::HL::W::World) const override;                                  \
    };                                                                         \
    }                                                                          \
                                                                               \
    ...
    {                                                                          \
                                                                               ...
                                                                               \
    std::unique_ptr<HighLevel> cls##HighLevelFactory::create_high_level(       \
        AI::HL::W::World world) const                                          \
    {                                                                          \
