...
class PASCHL_ST : public HighLevel {
public:
  PASCHL_ST(World &world) : world(world) {
...
void PASCHL_ST::robot_pass(int passer_num, int receiver_num, state next_state, Angle orientation) {
...
bool PASCHL_ST::ball_out_of_play() {
