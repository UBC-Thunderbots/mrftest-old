...
/**
 * An object whose velocity can be predicted based on a collection of prior
 * positions.
 */
class Predictable {
	public:
		 ...
		 *
		 * \return the predicted position \p delta_time after the most recent
		 * invocation of add_prediction_datum(const Point &, double).
		 */
		 ...
		 *
		 * \return the predicted orientation \p delta_time after the most recent
		 * invocation of add_prediction_datum(const Point &, double).
		 */
		 ...
		 *
		 * \return the predicted linear velocity in metres per second at the
		 * time of the most recent invocation of
		 ...
		 *
		 * \return the predicted angular velocity in radians per second at the
		 * time of the most recent invocation of
		 * add_prediction_datum(const Point &, double).
		 */
		 ...
		 *
		 * \return the predicted linear acceleration in metres per second
		 * squared at the time of the most recent invocation of
		 * add_prediction_datum(const Point &, double).
		 */
		 ...
		 *
		 * \return the predicted angular acceleration in radians per second
		 * squared at the time of the most recent invocation of
		 * add_prediction_datum(const Point &, double).
		 */
