...
tester_control_permotor_drive::tester_control_permotor_drive() : Gtk::HBox(false, 10), column1(true, 0), drive1_label("Drive 1:"), drive2_label("Drive 2:"), drive3_label("Drive 3:"), drive4_label("Drive 4:"), column2(true, 0), drive1_scale(-1023, 1024, 1), drive2_scale(-1023, 1024, 1), drive3_scale(-1023, 1024, 1), drive4_scale(-1023, 1024, 1) {
