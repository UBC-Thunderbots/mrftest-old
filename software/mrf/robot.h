...
class MRFRobot : public Drive::Robot {
	...
	private:
		...
		MRFDongle &dongle_;
		Annunciator::Message charge_timeout_message, breakout_missing_message, chicker_missing_message, crc_error_message, interlocks_overridden_message, low_capacitor_message;
