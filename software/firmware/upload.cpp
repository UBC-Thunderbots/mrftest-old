...
upload::upload(xbee_packet_stream &xbee, uint64_t bot, const std::vector<std::vector<uint8_t> > &data) : proto(xbee, bot), sched(data), status("Initializing..."), irpptr(0), irpmask(0) {
