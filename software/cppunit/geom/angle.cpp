...
void AngleTest::test_of_radians() {
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL(30, Angle::of_radians(M_PI / 6).to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(390, Angle::of_radians(M_PI * 13 / 6).to_degrees(), 0.1);
}

void AngleTest::test_of_degrees() {
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0, Angle::of_degrees(0).to_radians(), 0.01);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI / 3, Angle::of_degrees(60).to_radians(), 0.01);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(-M_PI, Angle::of_degrees(-180).to_radians(), 0.01);
}

void AngleTest::test_angle_mod() {
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(27).angle_mod().to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(360 + 27).angle_mod().to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(-27, Angle::of_degrees(360 - 27).angle_mod().to_degrees(), 0.1);
}

void AngleTest::test_angle_diff() {
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(50).angle_diff(Angle::of_degrees(23)).to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(360 + 13).angle_diff(Angle::of_degrees(-14)).to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(180 - 13).angle_diff(Angle::of_degrees(-180 + 14)).to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(180 + 13).angle_diff(Angle::of_degrees(-180 - 14)).to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(-180 + 13).angle_diff(Angle::of_degrees(180 - 14)).to_degrees(), 0.1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(27, Angle::of_degrees(-180 - 13).angle_diff(Angle::of_degrees(180 + 14)).to_degrees(), 0.1);
}
