...
void EncodeTest::test_word() {
	BitcodecPrimitives::Encoder<uint16_t, 0, 16>() (buffer, 0x1234); // 0b0001001000110100
...
void EncodeTest::test_word_shifted() {
	BitcodecPrimitives::Encoder<uint16_t, 8 + 5, 14>() (buffer, 0x1234); // 0b01001000110100
...
void EncodeTest::test_64_shifted() {
	...
	BitcodecPrimitives::Encoder<uint64_t, 16 + 3, 59>() (buffer, UINT64_C(0x023456789ABCDEFF));
	CPPUNIT_ASSERT_EQUAL(0x00, buffer[0] + 0); // <padding × 8>
