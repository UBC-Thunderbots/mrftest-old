...
/**
 * \brief A floating-point parameter representing an angle that can be edited by
 * means of a text field showing the angle in radians.
 */
class RadianParam final : public NumericParam
{
   public:
     ...
     */
    explicit RadianParam(
        const char *name, const char *location, double def, double min,
        double max);
...
/**
 * \brief A floating-point parameter representing an angle that can be edited by
 * means of a text field showing the angle in degrees.
 */
