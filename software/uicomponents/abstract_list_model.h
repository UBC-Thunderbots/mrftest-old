...
class AbstractListModel : public Gtk::TreeModel {
	protected:
		 ...
		 *
		 * \param[in] col the column number of the cell whose data should be fetched.
		 *
		 ...
		 * You must override this.
		 * If your data model should be read-only, you should do nothing in this function.
		 *
		 ...
		 * You must create \c Gtk::TreeModelColumn objects and add them to this record.
		 */
