...
namespace {
	...
	// basic
	const double DEF_X_PROP = 16.0157;
#ifdef TUNE_XY
	...
	const double DEF_X_DIFF = 46.6771;
#ifdef TUNE_XY
	...
	const double DEF_Y_PROP = 16.0157;
#ifdef TUNE_XY
	...
	const double DEF_Y_DIFF = 46.6771;
#ifdef TUNE_XY
	...
	// basic
	const double DEF_A_PROP = 12.6332;
#ifdef TUNE_ROTATION
	...
	const double DEF_A_DIFF = 40.3835;
#ifdef TUNE_ROTATION
