...
PowerPanel::PowerPanel(MRFDongle &dongle, unsigned int index) : Gtk::Table(2, 2), dongle(dongle), index(index), drivetrain_button(u8"Power Drivetrain"), kicker_button(u8"Power Kicker"), current_operation_status_entry(0) {
