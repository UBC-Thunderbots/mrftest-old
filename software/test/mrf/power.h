...
/**
 * \brief A panel that lets the user manually control power to various
 * subsystems
 */
class PowerPanel final : public Gtk::VButtonBox
{
   public:
    /**
   ...
   private:
    MRFDongle &dongle;
    unsigned int index;
    Gtk::Button power_drivetrain_button, reboot_button, shut_down_button,
