...
TesterFeedbackPanel::TesterFeedbackPanel(Drive::Dongle &dongle, Drive::Robot &robot) : Gtk::Table(7, 2), dongle(dongle), robot(robot), battery_voltage_label(u8"Battery:"), capacitor_voltage_label(u8"Capacitor:"), dribbler_temperature_label(u8"Dribbler:"), board_temperature_label(u8"Board:"), break_beam_reading_label(u8"Break Beam:"), alive(u8"Alive"), estop(u8"EStop Run"), ball_in_beam(u8"Ball in Beam"), capacitor_charged(u8"Capacitor Charged") {
	...
	attach(board_temperature_label, 0, 1, 3, 4, Gtk::SHRINK | Gtk::FILL, Gtk::SHRINK | Gtk::FILL);
	attach(board_temperature, 1, 2, 3, 4, Gtk::EXPAND | Gtk::FILL, Gtk::SHRINK | Gtk::FILL);
	attach(break_beam_reading_label, 0, 1, 4, 5, Gtk::SHRINK | Gtk::FILL, Gtk::SHRINK | Gtk::FILL);
	attach(break_beam_reading, 1, 2, 4, 5, Gtk::EXPAND | Gtk::FILL, Gtk::SHRINK | Gtk::FILL);
	...
	attach(cb_hbox1, 0, 2, 5, 6, Gtk::SHRINK | Gtk::FILL, Gtk::SHRINK | Gtk::FILL);
	cb_hbox2.pack_start(ball_in_beam, Gtk::PACK_EXPAND_WIDGET);
	cb_hbox2.pack_start(capacitor_charged, Gtk::PACK_EXPAND_WIDGET);
	attach(cb_hbox2, 0, 2, 6, 7, Gtk::SHRINK | Gtk::FILL, Gtk::SHRINK | Gtk::FILL);
...
void TesterFeedbackPanel::on_break_beam_reading_changed() {
	if (robot.alive) {
		break_beam_reading.set_fraction(clamp(robot.break_beam_reading / 1023.0, 0.0, 1.0));
