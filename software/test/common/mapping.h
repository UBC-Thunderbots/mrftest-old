...
class JoystickMapping final
{
   public:
    ...
    /**
     * \breif Returns the identifying information of the joystick handled by
     * this mapping.
     *
     ...
     *
     * \return \c true if \p axis has a corresponding physical mapping, or \c
     * false if not.
     */
     ...
     *
     * \return \c true if \p button has a corresponding physical mapping, or \c
     * false if not.
     */
