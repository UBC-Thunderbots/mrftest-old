...
TesterControlPerMotorDrive::TesterControlPerMotorDrive(XBeeRobot::Ptr bot) : Gtk::Table(4, 2, false), robot(bot), drive1_label("Drive 1:"), drive2_label("Drive 2:"), drive3_label("Drive 3:"), drive4_label("Drive 4:"), drive1_scale(-1023, 1023, 1), drive2_scale(-1023, 1023, 1), drive3_scale(-1023, 1023, 1), drive4_scale(-1023, 1023, 1) {
